...
def density_matrix(n):
    ...
    density_matrix[1][1] = (n - random_number) / n
    density_matrix[2][2] = random_number / n
    density_matrix[1][2] = np.sqrt(density_matrix[1][1] * density_matrix[2][2])
    density_matrix[2][1] = np.sqrt(density_matrix[1][1] * density_matrix[2][2])
